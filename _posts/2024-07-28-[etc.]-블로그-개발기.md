...
내가 내 머리속의 생각을 전부 구현해낼 수 있는 능력이 없기 때문에, 적절히 이상과 내 능력의 중간에서 타협을 해야하는 부분이 많았다.<br>
...
그래서 글의 카테고리를 나누고 그 카테고리를 마치 방처럼 들락날락 거리도록 구성했다.<br>
...
여기서 border-style 속성을 지우고, 색을 칠해서 좀 더 flat하고 minimal한 방향을 추구했다.(ㅋㅋ)<br>
그 결과가 지금의 디자인이다.<br>
<p class="post-image-wrapper">
...
색은 왜 초록색일까?<br>
그건 주인장인 내 맘이다.<br>
개인적으로 흰 바탕의 디자인이 굉장히 깔끔하고 미래적이라는 고정관념이 있다.<br>
